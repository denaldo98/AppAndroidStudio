...
public class tab4 extends Fragment {
    ...
    private CollectionReference giovediRef = db.collection("utenti").document(user.getUid()).collection("Giovedì");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapterOrario.setOnItemClickListener(new AdapterOrario.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                DialogOrario dialogModifyOrario = new DialogOrario(evento, path, 3, "Giovedì");
