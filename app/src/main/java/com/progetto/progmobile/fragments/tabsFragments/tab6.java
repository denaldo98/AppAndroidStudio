...
public class tab6 extends Fragment {
    ...
    private CollectionReference sabatoRef = db.collection("utenti").document(user.getUid()).collection("Sabato");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Query query = sabatoRef.orderBy("oraInizio", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerviewOrario6);
        ...
        adapterOrario.setOnItemClickListener(new AdapterOrario.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                DialogOrario dialogModifyOrario = new DialogOrario(evento, path, 5, "Sabato");
