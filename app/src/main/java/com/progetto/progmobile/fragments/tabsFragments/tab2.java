...
public class tab2 extends Fragment {
    ...
    private CollectionReference martediRef = db.collection("utenti").document(user.getUid()).collection("Martedì");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Query query = martediRef.orderBy("oraInizio", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerviewOrario2);
