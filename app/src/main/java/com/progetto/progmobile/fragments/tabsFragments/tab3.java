...
public class tab3 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Query query = mercolediRef.orderBy("oraInizio", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerviewOrario3);
        ...
        adapterOrario.setOnItemClickListener(new AdapterOrario.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                DialogOrario dialogModifyOrario = new DialogOrario(evento, path, 2, "Mercoledì");
