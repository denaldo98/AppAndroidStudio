...
public class tab5 extends Fragment {
    ...
    private CollectionReference venerdiRef = db.collection("utenti").document(user.getUid()).collection("Venerdì");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Query query = venerdiRef.orderBy("oraInizio", Query.Direction.ASCENDING);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerviewOrario5);
        ...
        adapterOrario.setOnItemClickListener(new AdapterOrario.OnItemClickListener() {
            ...
            public void onItemClick(DocumentSnapshot documentSnapshot, int position) {
                ...
                DialogOrario dialogModifyOrario = new DialogOrario(evento, path, 4, "Venerdì");
